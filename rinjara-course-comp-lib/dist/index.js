...
const Hero = _ref => {
  ...
  return React__default.createElement(material.Box, {
  ...
  }, React__default.createElement(material.Container, {
    maxWidth: 'sm'
    ...
    color: 'text.primary',
    gutterBottom: true
  }, "Genesis Academy"), React__default.createElement(material.Typography, {
    variant: 'h5',
    align: 'center',
    color: 'text.secondary',
    paragraph: true
  }, "Explore our catalog of courses available at Genesis Academy, a tech company dedicated to providing top-quality education in the latest technologies. Browse our courses and start your learning journey today!"), React__default.createElement(material.Stack, {
    sx: {
      pt: 4
    },
    direction: 'row',
...
const NavBar = () => {
  ...
  const handleClick = () => {
    ...
    if (!lastCourse) {
      notiflix.Notify.info('Please, choose your course in the list below!');
      return;
    }
    navigate(`/course/${lastCourse}`);
  };
  return React__default.createElement(material.Toolbar, {
    style: {
      gap: 10
    }
  }, React__default.createElement(Logo, null), React__default.createElement(material.Button, {
    variant: 'contained',
    component: NavLink,
    to: '/'
  }, "Courses"), React__default.createElement(material.Button, {
    onClick: handleClick,
    variant: 'contained'
  }, "My course"));
};
...
const SharedLayout = () => {
  return React__default.createElement(React.Fragment, null, React__default.createElement(material.AppBar, {
    position: 'relative'
  }, React__default.createElement(NavBar, null)), React__default.createElement("main", null, React__default.createElement(React.Suspense, {
...
const SkillsList = _ref => {
  ...
  return React__default.createElement(React.Fragment, null, React__default.createElement(material.CardActions, {
    disableSpacing: true,
    style: {
      padding: 0
    }
    ...
    "aria-label": 'more'
  }, React__default.createElement(ExpandMoreIcon, null))), React__default.createElement(material.Collapse, {
    in: isExpanded,
    timeout: 'auto',
    unmountOnExit: true
  }, React__default.createElement(material.CardContent, null, React__default.createElement(material.List, null, skills === null || skills === void 0 ? void 0 : skills.map(skill => React__default.createElement(material.ListItem, {
    key: skill
...
const VideoPlayer = _ref => {
  ...
  const handlePlayerError = e => {
    ...
    if (e !== null && e !== void 0 && (_e$target = e.target) !== null && _e$target !== void 0 && (_e$target$error = _e$target.error) !== null && _e$target$error !== void 0 && _e$target$error.code) {
      switch (e.target.error.code) {
        case 1:
          notiflix.Notify.warning('The video is not found or has been removed');
          break;
        case 2:
          notiflix.Notify.warning('The video is not playable in the current browser');
          break;
        case 3:
          notiflix.Notify.warning('The video has an invalid source');
          break;
        case 4:
          notiflix.Notify.info('To continue your lesson, please click play button');
          break;
        case 5:
          notiflix.Notify.warning('The video is too long');
          break;
        case 6:
          notiflix.Notify.warning('The video is not supported');
          break;
        default:
          notiflix.Notify.warning('An unknown error occurred while playing the video');
      }
    } else {
      notiflix.Notify.warning('An unknown error occurred while playing the video. Please, reload the page if needed');
    }
  };
  ...
  return React__default.createElement(React.Fragment, null, isVideoLoading && React__default.createElement(Loader, null), React__default.createElement(ReactPlayer$1, {
    url: URL,
    width: '100%',
    height: '100%',
    playing: true,
  ...
  }), React__default.createElement("div", null, React__default.createElement(material.Typography, {
    variant: 'subtitle2',
    component: 'p'
  }, "If you want to Increase playback speed - use combination \"Ctrl + Shift + S \""), React__default.createElement(material.Typography, {
    variant: 'subtitle2',
    component: 'p'
